...
const mockJobs: JobPosting[] = [
  {
    ...
    companyName: '네이버',
    description:
      'React, TypeScript를 활용한 웹 서비스 개발을 담당하실 프론트엔드 개발자를 모집합니다.',
  ...
  },
  {
    ...
    companyName: '카카오',
    description:
      'Spring Boot를 활용한 대규모 서비스 백엔드 개발을 담당하실 개발자를 찾습니다.',
  ...
  },
  {
    ...
    companyName: '삼성전자',
    description:
      '머신러닝 모델 개발 및 AI 서비스 구축을 담당하실 AI 엔지니어를 모집합니다.',
