        ...
        <div className='container mx-auto px-4'>
          <div className='flex h-16 items-center justify-between'>
            ...
            <Link href='/' className='flex items-center space-x-2 min-w-0'>
              ...
              {/* 로고 텍스트에 그라데이션 */}
              <span className='text-xl font-bold text-brand-gradient truncate'>
                C:Fit
              </span>
            </Link>
                ...
                <div className='space-y-2'>
                  ...
                  {user ? (
                    ...
                    <>
                      ...
                      {/* 모바일 회원가입도 그라데이션 버튼 느낌 */}
                      <Link
                        href='/register'
                        onClick={() => setIsMenuOpen(false)}
                        className='block py-[10px] text-center text-sm font-medium rounded-md bg-brand-gradient text-white hover:opacity-90'
                      >
                        회원가입
                      </Link>
                    </>
